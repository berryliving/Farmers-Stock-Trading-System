	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				...
				<br>
				<div>
					<textarea  name="pinfo" id="pinfo" rows="6" style="background-color: white;"></textarea >
				</div>
			<br>
			<div class="row">
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<input type="number" name="quantity" id="quantity" value="" placeholder="Quantity" style="background-color:white;color: black;" />
				</div>
				
			</div><br>
			<center>
			<div class="col-sm-6">
				<button class="button fit" style="width:auto; color:black; background-color:chocolate;">Submit</button>
			</div>
			</center>
			</form>
		</div>
