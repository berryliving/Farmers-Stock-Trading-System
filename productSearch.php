...
<html lang="en">
	...
	<body class="landing" style="background-image: url('images/banner.jpg');">
		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">Ardhi University<span>P.O.Box 35176</span></p>
				</div>
				<div>
					<i class="fa fa-phone"></i>
					<p style="font-size:20px">(+255)-738 357310</p>
				</div>
				<div>
					<i class="fa fa-envelope"></i>
					<p style="font-size:20px"><a href="mailto:artistkattawce@gmail.com" style="color:white">aru.ac.tz</a></p>
				</div>
			</div>

			<div class="footer-right">
				<p class="footer-company-about" style="color:white">
					<span style="font-size:20px"><b>About ARDHI UNIVERSITY</b></span>
					Ardhi University (ARU) is a public university in Dar es Salaam, Tanzania. it was established 28 March 2007,
					through it has been offering training for more than 60 years in different status.
				</p>
